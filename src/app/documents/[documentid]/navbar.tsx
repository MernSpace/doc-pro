...
export const Navbar = () => {
    ...
    const insartTable = ({rows,cols}:{rows:number,cols:number})=>{
        editor
        ?.chain()
        .focus()
    ...
    return (
        ...
        <nav className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
                <Link href='/'>
                    <Image src="/logo.svg" alt="loho" width={36} height={36} />
                </Link>
                            ...
                            <MenubarMenu>
                                ...
                                <MenubarContent>
                                    <MenubarSub>
                                        ...
                                        <MenubarSubContent>
                                            <MenubarItem onClick={()=>insartTable({rows:1,cols:1})}>
                                                1 x 1
                                            </MenubarItem>
                                            <MenubarItem onClick={()=>insartTable({rows:2,cols:2})}>
                                                2 x 2
                                            </MenubarItem>
                                            <MenubarItem onClick={()=>insartTable({rows:3,cols:3})}>
                                                3 x 3
                                            </MenubarItem>
                                            <MenubarItem onClick={()=>insartTable({rows:4,cols:4})}>
                                                4 x 4
                                            </MenubarItem>
                                        </MenubarSubContent>
                                    </MenubarSub>
